        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              RichText(
                ...
                TextSpan(
                    text: "${dataModel.formatStart()}\n",
                    style: LABEL_TEXT_STYLE),
                TextSpan(
                    text: "\nCloses on:\t",
                    style: LABEL_TEXT_STYLE_MEDIUM_BLACK),
                TextSpan(
                    text: "${dataModel.formatEnd()}\n",
                    style: LABEL_TEXT_STYLE),
                TextSpan(
                    text: "\nMax duration:\t",
                    style: LABEL_TEXT_STYLE_MEDIUM_BLACK),
                TextSpan(
                    text: "${dataModel.duration.inMinutes} minutes\n",
                    style: LABEL_TEXT_STYLE),
                TextSpan(
                    text: "\nNumber of Questions:\t",
                    style: LABEL_TEXT_STYLE_MEDIUM_BLACK),
                TextSpan(
                    text: "${dataModel.numberOfQuestions} \n",
                    style: LABEL_TEXT_STYLE),
              ])),
              Padding(
                          ...
                          FlatButton(
                            onPressed: () {
                              ...
                              FirebaseFirestore.instance
                                  ...
                                  .doc(dataModel.competitionId)
                                  .get()
                                  .then((doc) {
                                final data =
                                    CompetitionDataModel.fromMap(doc, 0);
                                if (data.documents.length > 0) {
                                  User user = Provider.of<UserAuthProvider>(
                                          context,
                                          listen: false)
                                      .authUser;
